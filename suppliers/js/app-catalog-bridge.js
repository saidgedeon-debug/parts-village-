 ...
 * Loads catalog data from localStorage for use in the Suppliers & Inquiries module.
 */
window.PVCatalog = {
    items: [],
    ...
    load() {
        ...
        // Dispatch event so UI knows catalog is ready
        document.dispatchEvent(new CustomEvent('catalogLoaded', { detail: { count: this.items.length } }));
        return this.items;
    },
    
    getSampleCatalog() {
        // Return sample catalog items for demonstration purposes
        // These include cost_price_supplier_a/b/c/d fields for testing auto-detection
        return [
            {
                item_code: "A01-1", 
                ...
                category: "Sensors",
                list_price: 45.00,
                cost_price_supplier_a: 30.00,
                cost_price_supplier_b: 28.50,
                cost_price_supplier_c: '',
                cost_price_supplier_d: 32.00,
            ...
            },
            {
                ...
                category: "Sensors",
                list_price: 38.50,
                cost_price_supplier_a: 25.00,
                cost_price_supplier_b: '',
                cost_price_supplier_c: 27.00,
                cost_price_supplier_d: 'N/A',
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                list_price: 125.00,
                cost_price_supplier_a: 85.00,
                cost_price_supplier_b: 82.00,
                cost_price_supplier_c: 88.00,
            ...
            },
            {
                ...
                category: "Engine Parts",
                list_price: 78.00,
                cost_price_supplier_a: 52.00,
                cost_price_supplier_b: 50.00,
                cost_price_supplier_c: '',
                cost_price_supplier_d: 55.00,
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                cost_price_supplier_b: 650.00,
                cost_price_supplier_c: 680.00,
                cost_price_supplier_d: 670.00,
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                category: "Hydraulic",
                list_price: 245.00,
                cost_price_supplier_a: 180.00,
                cost_price_supplier_b: '',
                cost_price_supplier_c: 190.00,
                cost_price_supplier_d: 185.00,
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                category: "Filters",
                list_price: 18.50,
                cost_price_supplier_a: 12.00,
                cost_price_supplier_b: 11.50,
                cost_price_supplier_c: 12.50,
                cost_price_supplier_d: '',
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                list_price: 22.00,
                cost_price_supplier_a: '',
                cost_price_supplier_b: 15.00,
                cost_price_supplier_c: '',
                cost_price_supplier_d: 16.00,
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                list_price: 156.00,
                cost_price_supplier_a: 110.00,
                cost_price_supplier_b: 105.00,
                cost_price_supplier_c: 115.00,
                cost_price_supplier_d: 'N/A',
                main_image: "../images/placeholder-part.png",
            ...
            },
            {
                ...
                category: "Undercarriage",
                list_price: 210.00,
                cost_price_supplier_a: 150.00,
                cost_price_supplier_b: '',
                cost_price_supplier_c: 155.00,
                cost_price_supplier_d: 148.00,
                main_image: "../images/placeholder-part.png",
